...
<section class="relative h-[500px] min-h-[560px] md:h-[93vh] md:min-h-[93vh] flex items-center overflow-hidden" style="padding-top: var(--header-height);">
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div class="hero-content max-w-2xl">
                ...
                <p class="text-white text-base md:text-[16px] tracking-wide mb-6 max-w-lg leading-relaxed [-webkit-text-stroke:0.2px_black]">
                    ...
                    <span class="text-[#a8d5a2] font-semibold">Rp 10.000</span>.
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="/tiket" class="bg-[#2d6a4f] hover:bg-[#245a40] text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-green-900/40 hover:-translate-y-0.5 active:translate-y-0">
                    ...
                    <a href="/profile" class="bg-white/20 hover:bg-white/30 text-white border border-white/50 px-8 py-3 rounded-full font-semibold backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5">
    ...
    <section class="py-[48px] bg-gradient-to-r from-[#1a3326] to-[#244533] overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center reveal-up" style="transition-delay: 0.1s;">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="/tiket" class="bg-white text-[#1a3326] hover:bg-gray-100 px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">

                    Beli Tiket Sekarang

                </a>

                <a href="/rating" class="bg-transparent text-white border border-white/70 hover:bg-white/10 px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:-translate-y-0.5">
