...
<div class="bg-[#eff3f0] min-h-screen pb-20" style="padding-top: var(--header-height);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="facility-card bg-white rounded-[24px] border border-gray-100 reveal-up flex flex-col shadow-sm hover:shadow-md transition-shadow" style="transition-delay: 0.15s;">
                    ...
                    <div class="facility-img-wrapper">
                        ...
                        <img src="/assets/images/loket.jpeg" class="facility-img" alt="Loket Tiket">
                ...
                <div class="facility-card bg-white rounded-[24px] border border-gray-100 reveal-up flex flex-col shadow-sm hover:shadow-md transition-shadow" style="transition-delay: 0.25s;">
                    ...
                    <div class="facility-content">
                        ...
                        <p class="text-gray-500 text-[14px] leading-relaxed">Fasilitas toilet yang bersih dengan pasokan air pegunungan alami. Tersedia juga bilik khusus untuk ganti pakaian.</p>
        ...
        <section class="max-w-7xl mx-auto px-6 lg:px-8 text-center reveal-up mb-10" style="transition-delay: 0.2s;">
            ...
            <div class="bg-gradient-to-r from-[#1a3326] to-[#244533] rounded-[32px] p-12 shadow-lg">
                ...
                <a href="/tiket" class="inline-block bg-white hover:bg-gray-100 text-[#1a3326] font-bold py-4 px-10 rounded-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
