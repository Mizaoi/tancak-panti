...
$notif_file = dirname(dirname(__DIR__)) . '/config/status_darurat.json';
...
$query_count_3 = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tiket WHERE status = 'Hangus' AND tanggal_kunjungan LIKE '$selected_month%'");
$count_3 = $query_count_3 ? mysqli_fetch_assoc($query_count_3)['total'] : 0;
...
<main class="flex-1 pt-8 pb-12 px-4 lg:px-6 max-w-[1440px] mx-auto w-full">
        ...
        <div class="bg-white rounded-[24px] p-6 flex flex-col md:flex-row justify-between items-center shadow-sm mb-6 border border-gray-100">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="/admin/logout" class="flex items-center gap-2 px-5 py-2.5 border border-gray-200 text-gray-500 rounded-[14px] text-[13px] font-bold hover:bg-gray-50 transition-colors">
        ...
        <div id="tab-data" class="tab-content <?= $active_tab == 'tab-data' ? 'active' : '' ?>">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-gray-100 rounded-[16px] p-5 text-center shadow-sm">
                    <div class="flex items-center justify-center gap-1.5 text-gray-700 font-bold text-[13px] mb-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                        Hangus
                    </div>
                    <div id="count-3" class="text-gray-800 text-[36px] font-extrabold leading-none mb-1 transition-all"><?= $count_3 ?></div>
                    <div class="text-gray-500 text-[12px] font-medium">tiket</div>
                </div>
            ...
            <div class="bg-white rounded-[16px] py-2.5 px-4 flex items-center shadow-sm mb-6 border border-gray-100 flex-wrap md:flex-nowrap gap-4">
                ...
                <div class="flex items-center gap-2 border-t md:border-t-0 md:border-l border-gray-200 pt-2 md:pt-0 md:pl-4 w-full md:w-auto">
                    ...
                    <input type="month" id="month-filter-tab1" value="<?= isset($_GET['bulan']) ? $_GET['bulan'] : date('Y-m'); ?>" onchange="window.location.href='/admin/dashboard?tab=tab-data&bulan=' + this.value" class="bg-[#f4f9f6] border border-[#1b3d2f] rounded-[8px] px-2 py-1.5 text-[12px] font-bold text-[#1b3d2f] outline-none cursor-pointer">
                    ...
                    <tbody id="wisatawan-tbody">
                        ...
                        <?php if($query && mysqli_num_rows($query) > 0): ?>
                            ...
                            <?php while($row = mysqli_fetch_assoc($query)): 
                                ...
                                } else if ($st_raw == 'Hangus') {
                                    $st_num = 3; $st_class = 'bg-gray-100 text-gray-800 border-gray-300';
                                } else {
        ...
        <div id="tab-rekap" class="tab-content <?= $active_tab == 'tab-rekap' ? 'active' : '' ?>">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <div class="bg-white border border-gray-200 rounded-[10px] px-3 py-2 flex items-center shadow-sm w-full md:w-auto">
                        ...
                        <input type="month" id="filter-bulan-rekap" value="<?= isset($_GET['bulan']) ? $_GET['bulan'] : date('Y-m'); ?>" onchange="window.location.href='/admin/dashboard?tab=tab-rekap&bulan=' + this.value" class="text-[13px] text-gray-600 font-medium outline-none bg-transparent cursor-pointer w-full">
                    ...
                    <button onclick="cetakLaporan()" class="bg-[#1a3326] hover:bg-[#12241b] text-white px-5 py-2.5 rounded-[10px] text-[13px] font-bold flex items-center gap-2 transition-colors shadow-sm whitespace-nowrap">
                        ...
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a２ ２ ０ ００－２ ２v４h１０z"></path></svg>
            ...
            <!-- 5 KOTAK INDIKATOR KECIL (TOTAL) -->
                ...
                <div class="bg-gray-50 rounded-[14px] p-4 border border-black-100 shadow-sm">
                ...
                <div class="bg-gray-50 rounded-[14px] p-4 border border-blue-100 shadow-sm">
                ...
                <div class="bg-gray-50 rounded-[14px] p-4 border border-green-100 shadow-sm">
                ...
                <div class="bg-gray-50 rounded-[14px] p-4 border border-red-100 shadow-sm">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-gray-100 rounded-[16px] p-6 text-center shadow-sm border border-gray-200">
                    <div class="text-gray-800 text-[40px] font-black leading-none mb-2"><?= $count_3 ?></div>
                    <div class="text-gray-700 text-[12px] font-bold tracking-wide">Hangus</div>
                </div>
            </div>
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="w-full text-left text-[13px]">
                            ...
                            <tbody id="tbody-rekap-sampah">
                                ...
                                <tr class="row-rekap-sampah border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                        ...
                        <div class="px-5 py-4 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between bg-white w-full gap-4">
                            <span id="page-info-sampah" class="text-[13px] text-gray-500 font-medium tracking-wide">Menampilkan 0 jenis</span>
                            <div id="pagination-controls-sampah" class="flex items-center gap-2"></div>
                        </div>
                    </div>
        ...
        <div id="tab-ulasan" class="tab-content <?= $active_tab == 'tab-ulasan' ? 'active' : '' ?>">
            ...
            <div class="bg-white border-b border-gray-200 w-full mb-6">
                ...
                <nav class="-mb-px flex space-x-4 overflow-x-auto custom-scrollbar" aria-label="Tabs">
                    ...
                    <a href="/admin/dashboard?tab=tab-ulasan" 
                    ...
                    <a href="/admin/dashboard?tab=tab-ulasan&status=menunggu" 
                    ...
                    <a href="/admin/dashboard?tab=tab-ulasan&status=disetujui" 
                    ...
                    <a href="/admin/dashboard?tab=tab-ulasan&status=ditolak" 
