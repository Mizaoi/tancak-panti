    ...
    <div class="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div class="hero-content max-w-2xl">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="profil.php" class="bg-white/20 hover:bg-white/30 text-white border border-white/50 px-8 py-3 rounded-full font-semibold backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5">
                    Lihat Detail
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div class="relative rounded-[24px] overflow-hidden reveal-zoom group cursor-pointer" style="transition-delay: 0.1s;">
                <img src="assets/images/foto1.png" alt="Galeri 1 - Air Terjun Tancak" class="w-full h-[350px] object-cover transition-transform duration-700 group-hover:scale-110">
                <div class="absolute inset-0 bg-black/30 group-hover:bg-black/0 transition-colors duration-500"></div>
            </div>

            <div class="relative rounded-[24px] overflow-hidden reveal-zoom group cursor-pointer" style="transition-delay: 0.2s;">
                <img src="assets/images/foto2.png" alt="Galeri 2" class="w-full h-[350px] object-cover transition-transform duration-700 group-hover:scale-110">
                <div class="absolute inset-0 bg-black/30 group-hover:bg-black/0 transition-colors duration-500"></div>
            </div>

            <div class="relative rounded-[24px] overflow-hidden reveal-zoom group cursor-pointer" style="transition-delay: 0.3s;">
                <img src="assets/images/foto3.png" alt="Galeri 3" class="w-full h-[350px] object-cover transition-transform duration-700 group-hover:scale-110">
                <div class="absolute inset-0 bg-black/30 group-hover:bg-black/0 transition-colors duration-500"></div>
            </div>
...
<section class="py-[48px] bg-gradient-to-r from-[#1a3326] to-[#244533] overflow-hidden">
    <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center reveal-up" style="transition-delay: 0.1s;">
        ...
        <p class="text-white/90 text-base md:text-[15px] mb-8">
