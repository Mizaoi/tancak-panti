        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="reveal-up" style="transition-delay: 0.3s;">
                ...
                <div class="space-y-4 text-[14px]">
                    <div class="flex items-start space-x-3 text-white/60 hover:text-white transition-colors">
                        <div class="bg-white/5 p-2 rounded-lg shrink-0">
                    ...
                    <div class="flex items-center space-x-3 text-white/60 hover:text-white transition-colors">
                        <div class="bg-white/5 p-2 rounded-lg shrink-0">
            ...
            <div class="reveal-up" style="transition-delay: 0.4s;">
                ...
                <div class="bg-white/5 rounded-2xl p-5 border border-white/5">
                    <p class="font-bold text-[#a8d5a2] text-[15px] mb-1">Setiap Hari (Senin - Minggu)</p>
                ...
                <div class="flex items-center space-x-3 mt-6">
                    <a href="https://www.instagram.com/tancakpanti/" target="_blank" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#2d6a4f] transition-all duration-300 text-white/70 hover:text-white">
