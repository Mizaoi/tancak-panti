...
<body class="flex flex-col min-h-screen text-gray-800">
    ...
    <main class="flex-1 pt-8 pb-12 px-4 lg:px-6 max-w-[1440px] mx-auto w-full">
        ...
        <div class="flex items-center gap-3 mb-6 overflow-x-auto no-scrollbar pb-2">
            <button class="flex items-center gap-2 bg-[#1a3326] text-white px-6 py-2.5 rounded-full text-[13px] font-bold shadow-md whitespace-nowrap">
            ...
            <button class="flex items-center gap-2 bg-white text-gray-500 px-6 py-2.5 rounded-full text-[13px] font-semibold border border-gray-200 hover:bg-gray-50 transition-colors whitespace-nowrap cursor-default">
